<?php
  ...
  $q = "SELECT a_id,art_title,artist_name,art_price,art_status,image,DATE_FORMAT(created_on,'%M %d, %Y') AS artwork_created_date FROM azteca_artwork where art_status=25";    
  $query=$dbh->prepare($q);
  $query->execute();
  ...
  if($query->rowCount() == 0){
   echo "No records found.";
    ...
    echo '<h2> Please subscribe to  our website to order any of the below listed artworks </h2>';
    ...
    <tr bgcolor = "#E0CCE0">
    <th><b>#</b></th>
    <th align="center"><b><a href="order_artwork.php?sort=art_title"> Title</a></b></th>
